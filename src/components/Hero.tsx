  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        background: 'linear-gradient(to bottom, rgba(0,0,0,0.08) 0%, rgba(0,0,0,0.38) 42%, rgba(253,246,240,0.92) 88%, #fdf6f0 100%)',
      }} />
      ...
      <div style={{ position: 'absolute', inset: 0, pointerEvents: 'none', overflow: 'hidden' }}>
        {HEARTS.map(h => (
          ...
          >
            <svg viewBox='0 0 24 24' fill='#e8b4b8' xmlns='http://www.w3.org/2000/svg'>
      ...
      >
        ...
        >
          Song{' '}
          <em style={{ fontStyle: 'italic', fontWeight: 300, color: '#f5dde0' }}>&amp;</em>
          {' '}Hoa
        </motion.h1>
        ...
        >
          <span style={{ display: 'block', width: 56, height: 1, backgroundColor: 'rgba(232,180,184,0.55)' }} />
          ✦ ♥ ✦
          <span style={{ display: 'block', width: 56, height: 1, backgroundColor: 'rgba(232,180,184,0.55)' }} />
        </motion.div>
